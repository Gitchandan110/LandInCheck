...
public class Base {
	...
	public static WebDriver chromeDriver() {
       ...
       public static void openLandInCheckApp() throws InterruptedException, IOException {
		
		chromeDriver();
		String urlApp=ExcelUtils.ReadExcel(InputDataSheet, 1, 1);
		driver.get(urlApp);
		Thread.sleep(5000);
	}
	...
	public static void takeScreenShot(String screenName) throws IOException {
		...
		String imageLocation = "C:\\Users\\Chandan\\Git\\LandInCheck\\AIdGLendInCheck\\Screenshots\\";
